...
- (void)viewDidLoad
{
    ...
    UIAlertController *welcome = [UIAlertController alertControllerWithTitle:@"Pojav Patch" message:[NSString stringWithFormat:@"%@: %@-%s\nបង្កើតឡើងដោយ DREVENANT", NSLocalizedString(@"welcome.version", nil), NSBundle.mainBundle.infoDictionary[@"CFBundleShortVersionString"], CONFIG_TYPE] preferredStyle:UIAlertControllerStyleAlert];
